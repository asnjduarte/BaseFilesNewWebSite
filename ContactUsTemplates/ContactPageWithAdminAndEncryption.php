...
<div class="w100 h700 flx rel mb_Flxdc mb_ha">
	...
	<div class="w50 ma p20 mb_w100 z1">
		<div class="gBx gBxShd2Wht">
			<h2>Direcciones</h2>
			<div>
				<div class="ptb5"><?php echo $cacheCompanyInfo->get()["Links"][5][1];?></div>
			</div>
		</div>
        <div class="gBx gBxShd2Wht">
			<h2>Subscribe</h2>
			...
			<div class="flx fwrap">
				<?php  foreach ($cacheCompanyInfo->get()["Links"] as $k => $v) { 
					  if ($v[3] == 1) { //type 1 = contact?>
						<div class="p10 pl0">
							<a class="flx fwrap aic" href="<?php echo $v[2]?>" target="_blank">
							<div class="bx30 <?php echo $v[4]?> cnnr"></div>
							<?php echo $v[1]?></a>
						</div>
				<? 	 } else if ($v[3] == 2) { // type 2 = social ?>
					<div class="p10 pl0">
						<a href="<?php echo $v[2]?>" target="_blank"><div class="bx30 <?php echo $v[4]?> cnnr"></div></a>
					</div>
				<?php }} ?>
			</div>
		</div>
